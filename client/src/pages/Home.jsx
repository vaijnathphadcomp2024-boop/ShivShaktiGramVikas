...
export default function Home() {
  return (
    <main>
      ...
      >
        ...
        <div className="relative z-10 animate-fadeInUp max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-white text-center">
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <div key={label} className="bg-white/10 backdrop-blur rounded-2xl p-4 border border-white/10">
                <p className="text-2xl sm:text-3xl font-extrabold text-saffron">{num}</p>
          ...
          <div className="mt-10 h-2 rounded-full bg-white/10 overflow-hidden">
            <div className="h-full bg-saffron animate-heroProgress" aria-hidden="true" />
          </div>
        </div>
      </section>
      ...
      {/* ── 6. Quote Banner ───────────────────────────────────────────────── */}
      <section className="bg-[#0f2744] text-white py-16 px-4 sm:px-6 lg:px-8">
      ...
      <section className="bg-[#e11d48] text-white py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="text-center">
                <p className="text-white font-bold">📍 किनगाव, ता. अहमदपूर, जि. लातूर, महाराष्ट्र</p>
              </div>
            </div>
