...
function SectionHeading({ tag, title, subtitle, light = false }) {
  return (
    <div className="text-center mb-6">
      ...
      <div className="mt-3 mx-auto w-16 h-1 rounded-full bg-magenta" />
    </div>
  );
}
...
export default function SafetyCollege() {
  ...
  return (
    <main>
      ...
      <section
        id="safety-hero"
        className="relative overflow-hidden hero-section bg-gradient-to-br from-magenta via-rose-700 to-[#7f0022] py-12 flex items-center"
      >
        ...
        <div className="relative z-10 animate-fadeInUp max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 text-white text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur border border-white/30 rounded-full px-4 py-1 text-xs sm:text-sm mb-3 font-semibold">
          ...
          <p className="max-w-xl mx-auto text-sm sm:text-base text-rose-100 leading-relaxed mb-5">
            A government-recognised, MSBTE-affiliated institute offering professional
            diplomas in Industrial Safety and Fire & Safety Engineering.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center flex-wrap">
            <a
              href="#courses"
              className="px-6 py-2.5 rounded-full bg-white/15 hover:bg-white/25 border border-white/30 text-white font-bold text-sm transition-all duration-200 hover:-translate-y-0.5"
            >
              Explore Courses ↓
            </a>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto">
            {[
              ...
              { n: '120',    l: 'Total Seats'           },
              { n: '100+',   l: 'Alumni Placed'         },
              { n: '2026',   l: 'MSBTE Affiliated Since' },
            ].map(({ n, l }) => (
              <div key={l} className="bg-white/15 backdrop-blur rounded-xl p-3 border border-white/20">
                <p className="text-xl sm:text-2xl font-extrabold">{n}</p>
                <p className="text-[11px] sm:text-xs text-rose-200 mt-0.5 leading-tight">{l}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── 2. About the College ──────────────────────────────────────────── */}
      <section id="about-college" className="py-10 px-4 sm:px-6 lg:px-8 bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="space-y-5 text-gray-600 leading-relaxed">
              <p>
                ...
                Shivshakti GramVikas Pratishthan, is a government-recognised technical institution
              ...
              <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-magenta to-[#7f0022] p-8 text-white shadow-2xl">
                ...
                <dl className="space-y-3 text-sm">
                  {[
                    ...
                    { dt: 'MSBTE Affiliation',    dd: 'Affiliated Since 2026' },
      ...
      {/* ── 3. Courses Offered ────────────────────────────────────────────── */}
      {courses.length > 0 && (
      <section id="courses" className="py-10 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
      ...
      {/* ── 6. Faculty Profiles ───────────────────────────────────────────── */}
      {faculty.length > 0 && (
      <section id="faculty" className="py-10 px-4 sm:px-6 lg:px-8 bg-white">
      ...
      {/* ── 8. Placement Support ──────────────────────────────────────────── */}
      {placements.length > 0 && (
      <section id="placements" className="py-10 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-navy via-[#0f2d4a] to-magenta">
        <div className="max-w-5xl mx-auto">
          <SectionHeading
            tag="Career Support"
