...
function EnquiryForm() {
  const INIT = { parentName: '', phone: '', email: '', childAge: '', message: '' };
  ...
  const validate = () => {
    ...
    if (!form.childAge)                            e.childAge   = 'Please select your child\'s age group.';
  ...
  const handleSubmit = (e) => {
    ...
    setSubmitting(true);
    setTimeout(() => {
      console.log('📋 PreSchool Enquiry Form Submitted:', form);
      setSubmitting(false);
      setSubmitted(true);
      setForm(INIT);
    }, 800);
  ...
  const inputCls = (field) =>
    `w-full rounded-xl border px-4 py-3 text-sm text-gray-800 bg-white focus:outline-none focus:ring-2 transition-colors ${
      errors[field]
        ...
        : 'border-gray-200 focus:ring-saffron/40 focus:border-saffron'
    }`;
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center py-16 px-4 text-center gap-4">
        ...
        <h3 className="text-2xl font-extrabold text-navy">Enquiry Submitted!</h3>
        <p className="text-gray-500 max-w-sm">
          Thank you for your interest. Our admissions team will call you within 24 hours.
        </p>
        <button
          onClick={() => setSubmitted(false)}
          className="mt-2 px-6 py-2.5 rounded-full bg-saffron hover:bg-orange-500 text-white font-semibold transition-colors"
        >
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="grid sm:grid-cols-2 gap-5">
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="ps-parentName" className="text-sm font-semibold text-navy">
      ...
      {/* Phone */}
      <div className="flex flex-col gap-1">
        <label htmlFor="ps-phone" className="text-sm font-semibold text-navy">
      ...
      {/* Email */}
      <div className="flex flex-col gap-1">
        <label htmlFor="ps-email" className="text-sm font-semibold text-navy">
      ...
      {/* Child Age */}
      <div className="flex flex-col gap-1">
        <label htmlFor="ps-childAge" className="text-sm font-semibold text-navy">
        ...
        <select
          ...
          value={form.childAge}
          onChange={handleChange}
          className={inputCls('childAge')}
        >
          <option value="">— Select age group —</option>
          <option value="2-3">2 – 3 years (Toddler)</option>
          <option value="3-4">3 – 4 years (Nursery)</option>
          <option value="4-5">4 – 5 years (Junior KG)</option>
          <option value="5-6">5 – 6 years (Senior KG)</option>
        </select>
      ...
      <div className="sm:col-span-2 flex flex-col gap-1">
        <label htmlFor="ps-message" className="text-sm font-semibold text-navy">
        ...
        <textarea
          ...
          name="message"
          rows={4}
          placeholder="Any questions, preferred admission date, or special requirements…"
          value={form.message}
          onChange={handleChange}
      ...
      <div className="sm:col-span-2">
        <button
          id="ps-enquiry-submit"
          type="submit"
          disabled={submitting}
          className="w-full sm:w-auto px-10 py-3.5 rounded-full bg-saffron hover:bg-orange-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold text-base shadow-lg shadow-orange-300/40 hover:shadow-orange-400/50 transition-all duration-200 hover:-translate-y-0.5 flex items-center justify-center gap-2"
        >
          {submitting ? (
            <>
        ...
        <p className="mt-2 text-xs text-gray-400">
          * All fields are required. We'll call you within 24 hours.
        </p>
      </div>
    </form>
  );
...
export default function PreSchool() {
  return (
    <main>
      ...
      {/* ── 8. Enquiry Form ───────────────────────────────────────────────── */}
      <section id="ps-enquiry" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-3xl mx-auto">
          <SectionHeading
            tag="Get in Touch"
            title="Admission Enquiry"
            subtitle="Interested in enrolling your child? Fill in the form and we'll get back to you within 24 hours."
          />

          <div className="bg-white border border-gray-100 rounded-3xl shadow-xl p-6 sm:p-10">
            {/* Saffron top accent bar */}
            <div className="h-1.5 w-24 rounded-full bg-saffron mb-8" />
            <EnquiryForm />
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-saffron/10 border border-saffron/30 text-saffron font-semibold text-sm hover:bg-saffron hover:text-white transition-colors"
            >
